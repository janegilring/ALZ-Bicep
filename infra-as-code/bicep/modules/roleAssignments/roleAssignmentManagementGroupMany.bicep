...
@description('A list of management group scopes that will be used for role assignment (i.e. [con-platform-connectivity, con-platform-identity]). Default: Empty Array')
